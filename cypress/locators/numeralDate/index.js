import { NUMERAL_DATE_COMPONENT, NUMERAL_DATE_DEFAULT } from './locators';
...
// DS locators
export const numeralDateDefault = () => cy.iFrame(NUMERAL_DATE_DEFAULT)
  .find(NUMERAL_DATE_COMPONENT).find(DATE_INPUT);
export const numeralDateInputByPositionDS = index => numeralDateDefault().eq(index);
